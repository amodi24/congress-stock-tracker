...
- `.github/workflows/update.yml` runs both scripts automatically every day at 7:00 PM US/Eastern (after market close) and commits any new data, which GitHub Pages then redeploys automatically.
